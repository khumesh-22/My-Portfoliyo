    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full text-lg">
        ...
        <p className="mb-4 py-6">
          Hey! I'm based on Digikull and I'm Professional with more than 1years
          of experience as a frontend developer education. However, felt that I
          had the potential for more, so my intellectual curiosity led me to
        ...
        <p>
          ...
          and I am sure that I will be able to create incredible projects
